...
public class Utils {
    ...
    public static int sendAsEmail(final Context app, final File file, String email)
    {

        AlertDialog.Builder adb = new AlertDialog.Builder(app);
        ...
        adb.setPositiveButton("Send", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if((!address.getText().toString().isEmpty()) && (file != null))
                {
                    ...
                    ei.putExtra(Intent.EXTRA_STREAM, Uri.parse("file://" + file.getAbsolutePath()));
                    app.startActivity(Intent.createChooser(ei,"Send Email"));
                }
